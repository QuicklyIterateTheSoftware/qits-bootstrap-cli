...
public final class ComposeTemplate {
            ...
            services:
              ...
              qits-platform-edge:
                ...
                environment:
                  ...
                  #
                  # THE CLIENT ID IS THE WIRE ALIAS, and ${ALIAS_PLATFORM_EDGE} is that alias — bare
    ...
    private static final String EXTRAS = """
            ...
            ${EDGE_TLS_NOTE}qits.deployments.extras.qits-platform-edge.publishes[0]=${PORT}:8080
            ...
            qits.deployments.extras.qits-platform-edge.aliases[0]=registry.${ENV_NAME}.localhost
            qits.deployments.extras.qits-platform-edge.aliases[1]=mirror.${ENV_NAME}.localhost
            qits.deployments.extras.qits-platform-edge.aliases[2]=githost.${ENV_NAME}.localhost
            qits.deployments.extras.qits-platform-edge.aliases[3]=githost.${ENV_NAME}.internal
            ...
            qits.deployments.extras.qits-platform-edge.env.QITS_EDGE_APPS_GITHOST_AUDIENCE_PATTERN={env}-qits-githost
            ...
            qits.deployments.extras.qits-platform-edge.env.QITS_EDGE_APPS_EDITOR_HOST_PATTERN={env}-qits-workspaces
            qits.deployments.extras.qits-platform-edge.env.QITS_EDGE_APPS_EDITOR_AUDIENCE_PATTERN={env}-qits-workspaces
            ...
            # — PdNetworks.alias, which answers the bare qits-platform-edge on the platform plane —
            ...
            qits.deployments.extras.qits-platform-edge.env.QITS_EDGE_SESSIONS_ENABLED=true
            qits.deployments.extras.qits-platform-edge.env.QITS_EDGE_SESSIONS_CANONICAL_ORIGIN=${PUBLIC_ORIGIN}
            qits.deployments.extras.qits-platform-edge.env.QITS_EDGE_SESSIONS_BROWSER_HOSTS=${BROWSER_HOSTS}
            qits.deployments.extras.qits-platform-edge.env.QITS_OBSERVABILITY_URL=http://${ENV_NAME}-qits-observability:8080${EDGE_TLS_ARGS}
            ...
            qits.deployments.extras.qits-platform-mirror.env.QITS_OBSERVABILITY_URL=http://${ENV_NAME}-qits-observability:8080
            ...
            qits.deployments.extras.qits-ci.env.QITS_ARTIFACTS_NPM_PROXY_URL=http://${DIAL_PLATFORM_MIRROR}:8080/artifacts/npm/npmjs/
            ...
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_AUTH_MACHINE_REQUIRED=${MACHINE_REQUIRED}
            qits.deployments.extras.qits-platform-orchestrator.env.QUARKUS_OIDC_AUTH_SERVER_URL=${IDP_DIAL}
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_ORCHESTRATOR_TARGETS_ARTIFACTS_URL=http://${ALIAS_ARTIFACTS}:8080
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_ORCHESTRATOR_TARGETS_CONTAINERS_URL=http://${ALIAS_CONTAINERS}:8080
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_ORCHESTRATOR_TARGETS_CI_URL=http://${ALIAS_CI}:8080
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_ORCHESTRATOR_TARGETS_DEPLOYMENTS_URL=http://${DIAL_DEPLOYMENTS}:8080
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_ORCHESTRATOR_TARGETS_PROJECTS_URL=http://${ALIAS_PROJECTS}:8080
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_ORCHESTRATOR_TARGETS_WORKSPACES_URL=http://${ALIAS_WORKSPACES}:8080
            ...
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_ORCHESTRATOR_TARGETS_CONFIGURATION_URL=http://${DIAL_CONFIGURATION}:8080
            qits.deployments.extras.qits-platform-orchestrator.env.QITS_OBSERVABILITY_URL=http://${ENV_NAME}-qits-observability:8080
    ...
    private static final String EXTRAS_REST = """
            ...
            qits.deployments.extras.qits-platform-idp.env.QITS_IDP_ISSUER=${IDP}
            ...
            qits.deployments.extras.qits-platform-idp.env.QITS_IDP_BROWSER_SSO_CANONICAL_ORIGIN=${IDP_ORIGIN}
            qits.deployments.extras.qits-platform-idp.env.QITS_IDP_BROWSER_SSO_BROWSER_HOSTS=${BROWSER_HOSTS}
            qits.deployments.extras.qits-platform-idp.env.QITS_IDP_BROWSER_SSO_COOKIE_DOMAIN=${SESSION_COOKIE_DOMAIN}
            ...
            qits.deployments.extras.qits-platform-idp.env.QITS_IDP_WEBAUTHN_RP_ID=${WEBAUTHN_RP_ID}
            qits.deployments.extras.qits-platform-idp.env.QITS_IDP_WEBAUTHN_ORIGINS=${WEBAUTHN_ORIGINS}
            qits.deployments.extras.qits-platform-idp.env.QITS_OBSERVABILITY_URL=http://${ENV_NAME}-qits-observability:8080
            ...
            qits.deployments.extras.qits-projects.env.QITS_PROJECTS_RELEASE_REQUESTS_MAINTENANCE_URL=http://${DIAL_PLATFORM_MAINTENANCE}:8080
            ...
            qits.deployments.extras.qits-workspaces.env.QITS_WORKSPACE_NPM_PROXY_URL=http://${DIAL_PLATFORM_MIRROR}:8080/artifacts/npm/npmjs/
            ...
            qits.deployments.extras.qits-platform-maintenance.env.QITS_AUTH_MACHINE_REQUIRED=${MACHINE_REQUIRED}
            qits.deployments.extras.qits-platform-maintenance.env.QUARKUS_OIDC_AUTH_SERVER_URL=${IDP_DIAL}
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_TARGETS_PROJECTS_URL=http://${ALIAS_PROJECTS}:8080
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_TARGETS_GITHOST_URL=http://${ALIAS_GITHOST}:8080
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_TARGETS_CI_URL=http://${ALIAS_CI}:8080
            ...
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_TARGETS_ARTIFACTS_URL=http://${ALIAS_ARTIFACTS}:8080
            ...
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_BUMP_INTERNAL_AUTO=true
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_REGISTRIES_MAVEN_URL=http://${ALIAS_ARTIFACTS}:8080/artifacts/maven/maven
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_REGISTRIES_NPM_URL=http://${ALIAS_ARTIFACTS}:8080/artifacts/npm/npm
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_REGISTRIES_OCI_URL=http://${ALIAS_ARTIFACTS}:8080/v2
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_MIRROR_MAVEN_URL=http://${DIAL_PLATFORM_MIRROR}:8080/artifacts/maven/central
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_MIRROR_NPM_URL=http://${DIAL_PLATFORM_MIRROR}:8080/artifacts/npm/npmjs
            qits.deployments.extras.qits-platform-maintenance.env.QITS_MAINTENANCE_ENVIRONMENT=${ENV_NAME}
            qits.deployments.extras.qits-platform-maintenance.env.QITS_OBSERVABILITY_URL=http://${ENV_NAME}-qits-observability:8080
            ...
            qits.deployments.extras.qits-platform-system.mounts[0]=bind:/var/run/docker.sock:/var/run/docker.sock
            qits.deployments.extras.qits-platform-system.mounts[1]=volume:qits-platform-system-config:/work/config
            qits.deployments.extras.qits-platform-system.groups[0]=${DOCKER_GID}
            qits.deployments.extras.qits-platform-system.env.DOCKER_CONFIG=/work/config
            qits.deployments.extras.qits-platform-system.env.QITS_AUTH_MACHINE_REQUIRED=${MACHINE_REQUIRED}
            qits.deployments.extras.qits-platform-system.env.QUARKUS_OIDC_AUTH_SERVER_URL=${IDP_DIAL}
            qits.deployments.extras.qits-platform-system.env.QITS_SYSTEM_GLANCES_IMAGE_REPO=mirror.${ENV_NAME}.localhost:${PORT}/hub/nicolargo/glances
            qits.deployments.extras.qits-platform-system.env.QITS_SYSTEM_GLANCES_IMAGE_VERSION=4.5.6-full
            qits.deployments.extras.qits-platform-system.env.QITS_OBSERVABILITY_URL=http://${ENV_NAME}-qits-observability:8080
            """;
}
